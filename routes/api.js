...
module.exports = function (app) {
  ...
  const uri = 'mongodb+srv://dalo:'+process.env.PW+'@cluster0.go9tq.mongodb.net/stockprice?retryWrites=true&w=majority'
    ...
    .get(function (req, res){
      ...
      let getPrice = (stockDocument, nextStep) => {
        ...
        xhr.onload = () => {
          ...
          stockDocument['price'] = apiResponse['latestPrice'].valueOf()
